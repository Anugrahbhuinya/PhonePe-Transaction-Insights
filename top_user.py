...
base_path = r"C:\Users\ASUS\Desktop\PhonPe\pulse\data\top\user\country\india"
        ...
        if file.endswith(".json") and file.replace('.json','') in ['2','3','4']:
            ...
            if districts and isinstance(districts, list):
                for district_data in districts:
                    ...
                    registered_users = district_data.get('registeredUsers', None)
                    app_opens = district_data.get('appOpens', None)
...
cursor.close()
conn.close()
print("✅ top_user data load complete.")
